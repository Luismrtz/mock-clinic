...
const Hero = () => {
  return (
    <div className="relative w-full h-[400px] sm:h-[500px] lg:h-[600px] overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col gap-4 justify-center sm:items-start items-center text-center sm:text-left px-6 sm:px-12 lg:px-20 text-gray-900">
        <h1 className="text-3xl text-primary sm:text-4xl lg:text-5xl font-bold">
          Your Health, Our Priority
        </h1>
        <p className="mt-2 text-lg hidden sm:inline-block sm:text-xl lg:text-2xl max-w-[500px]">
